...
function BookCard() {
   return (
      <div className='book-card group'>
         <img src="harry-potter.jpg" alt="book" className="rounded-3xl w-full" style={{ height: '60%' }} />
         ...
         <div className="relative flex w-full mt-10 ">
            <div className="flex group-hover:invisible w-full justify-between text-gray px-7">
